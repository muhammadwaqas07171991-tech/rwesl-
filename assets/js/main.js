...
// Drone Video Interactive HUD Controls
function toggleDroneAudio() {
  const video = document.getElementById('dronePlayer');
  const muteText = document.getElementById('droneMuteText');
  const muteIcon = document.getElementById('droneMuteIcon');
  if (!video) return;
...
function toggleDronePlay() {
  const video = document.getElementById('dronePlayer');
  const playText = document.getElementById('dronePlayText');
  const playIcon = document.getElementById('dronePlayIcon');
  if (!video) return;
